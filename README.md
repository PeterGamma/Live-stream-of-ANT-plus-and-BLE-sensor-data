...
Garmin HRM Dual, Polar OH1, Stryd, etc. should work with the Matlab BLE example. The door is open for a real-time indoor activity monitoring system using Matlab. Only the Matlab BLE example needs to be integrated and tested.
