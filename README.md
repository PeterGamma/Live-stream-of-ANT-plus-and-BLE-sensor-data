...
Polar OH1 should work with the Matlab BLE example, and Stryd foot pod should work with the Matlab BLE example. All problems are solved  for a real-time indoor activity monitoring system with Matlab, Polar OH1 and Stryd. The Matlab BLE example needs to be integrated and tested.
