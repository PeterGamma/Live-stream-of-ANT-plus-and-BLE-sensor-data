...
43. Send BLE sensor data from the Adafruit Clue chip (Pyloton Open Source Bike computer) to Adafruit IO with a Raspberry Pi bridge (By John Parkhttps://learn.adafruit.com/users/johnpark , Adafruit):
